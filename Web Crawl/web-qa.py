...
if TFWIKI:
    domain = "tfwiki.net"
    full_url = "https://tfwiki.net/wiki/Optimus_Prime_(G1)/toys"
...
if TFWIKI:
    print("\What is Energon?\n")
    print(answer_question(df, question="What is Energon?", debug=False))
    time.sleep(3)

    print("\ntell me about G1 Optimus Prime?\n")
    print(answer_question(df, question="tell me about G1 Optimus Prime?"))
    time.sleep(3)

    print("\ntell me about Powermaster Optimus Prime\n")
    print(answer_question(df, question="tell me about Powermaster Optimus Prime"))
while (True):
    prompt = input("\nEnter your question: \n")
